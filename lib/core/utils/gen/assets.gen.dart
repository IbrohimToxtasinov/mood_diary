...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/mood_diary.svg
  SvgGenImage get moodDiary => const SvgGenImage('assets/icons/mood_diary.svg');

  /// File path: assets/icons/statistic.svg
  SvgGenImage get statistic => const SvgGenImage('assets/icons/statistic.svg');

  /// List of all assets
  List<SvgGenImage> get values => [calendar, moodDiary, statistic];
}
...
class $AssetsImagesGen {
  ...
  List<AssetGenImage> get values =>
      [calmness, fear, happy, rabies, sadness, strength];
}
